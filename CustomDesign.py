...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.run_dt_browser = QtWidgets.QPushButton(self.centralwidget)
        self.run_dt_browser.setGeometry(QtCore.QRect(580, 80, 131, 51))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.run_dt_browser.setFont(font)
        self.run_dt_browser.setObjectName("browser dt")
        self.run_dt_browser.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))

        self.run_ad_browser = QtWidgets.QPushButton(self.centralwidget)
        self.run_ad_browser.setGeometry(QtCore.QRect(720, 80, 131, 51))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.run_ad_browser.setFont(font)
        self.run_ad_browser.setObjectName("browser ad")
        self.run_ad_browser.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.run_dt_browser.setText(_translate("MainWindow", "DT Браузер"))
        self.run_ad_browser.setText(_translate("MainWindow", "AD Браузер"))
