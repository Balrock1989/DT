...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.data_start_label.setGeometry(QtCore.QRect(610, 160, 201, 16))
        font = QtGui.QFont()
        font.setBold(False)
        ...
        self.url.setGeometry(QtCore.QRect(580, 320, 261, 31))
        self.url.setObjectName("url")

        self.url_label = QtWidgets.QLabel(self.centralwidget)
        self.url_label.setGeometry(QtCore.QRect(620, 300, 191, 16))
        font = QtGui.QFont()
        font.setItalic(False)
        font.setUnderline(True)
        ...
        self.run_browser_button = QtWidgets.QPushButton(self.centralwidget)
        self.run_browser_button.setGeometry(QtCore.QRect(580, 80, 131, 51))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.run_browser_button.setFont(font)
        self.run_browser_button.setObjectName("webdriver_button")
        self.run_browser_button.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))

        self.webdriver_run_func = QtWidgets.QPushButton(self.centralwidget)
        self.webdriver_run_func.setGeometry(QtCore.QRect(720, 80, 131, 51))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.webdriver_run_func.setFont(font)
        self.webdriver_run_func.setObjectName("webdriver_run_func")
        self.webdriver_run_func.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.run_browser_button.setText(_translate("MainWindow", "Браузер"))
        self.webdriver_run_func.setText(_translate("MainWindow", "Shift+F1(Run)"))
